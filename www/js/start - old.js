...
var enjoyhint_script_steps = [
    ...
    {
    "click #skip" : "Приложение работает <br/>пока только <br/>в городе Санкт-Петербург.<br/>Мы работаем над покрытием других городов России.<br/>Подробную информацию вы сможете узнать на нашем официальном сайте<br/>https://clicaid.maya.place/",
	onEnd: true,
